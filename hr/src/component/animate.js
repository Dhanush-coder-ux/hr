  ...
  return (
    <StyledWrapper>
      <button className="button" onClick={handleClick}>
        ...
        <span className="text_button">ContactUS</span>
      </button>
    </StyledWrapper>
  );
};
...
const StyledWrapper = styled.div`
  ...
  .button::before {
    ...
    box-shadow:
      ...
      0 0 0 calc(var(--active, 0) * 0.375rem) hsl(220, 97%, 60%, 0.75); /* blue glow */
  ...
  .button::after {
    ...
    width: 100%;
    height: 100%;
    background-color: hsla(220, 100%, 70%, 0.25); /* blue overlay */
    background-image: radial-gradient(
        at 51% 89%,
        hsla(220, 60%, 75%, 1) 0px,
        transparent 50%
      ),
      radial-gradient(at 100% 100%, hsla(220, 60%, 70%, 1) 0px, transparent 50%),
      radial-gradient(at 22% 91%, hsla(220, 60%, 60%, 1) 0px, transparent 50%);
